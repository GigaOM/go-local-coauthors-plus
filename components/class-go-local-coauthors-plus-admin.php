...
class GO_Local_Coauthors_Plus_Admin
{
	...
	public function admin_enqueue_scripts( $hook )
	{
		...
		wp_register_script( 'mockjax', plugins_url( 'js/' . $js_min . '/external/jquery.mockjax.js', __FILE__ ), array(), '1.5.1', TRUE );
		wp_register_script( 'go-local-coauthors-plus-admin', plugins_url( 'js/' . $js_min . '/go-local-coauthors-plus-admin.js', __FILE__ ), array( 'jquery', 'co-authors-plus-js', 'mockjax' ), $this->version, TRUE );
